...
3. Make a copy of [server.local.cfg.example](server.local.cfg.example) to `server.local.cfg` and make the necessary updates. Ensure you set the `sv_licenseKey`, whic